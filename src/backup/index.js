      ...
      <div style={{ display: 'flex' }}>
        ...
        <div className={isBurgerClicked ? classes.sideBarAfter : classes.sideBarBefore}>
          ...
          <div className={classes.onBtnNav}>
            ...
            <div style={{ marginTop: "90px", }}>{true ? <h4 style={{ marginLeft: "20px" }}>GENERAL</h4> : <h4 style={{ marginLeft: "20px" }}></h4>}</div>
            <div>
            ...
            <div style={{ marginTop: "55px", }}>{true ? <h4 style={{ marginLeft: "20px" }}>MANAGEMENT</h4> : <h4 style={{ marginLeft: "20px" }}></h4>}</div>
            <div>
            ...
            <div style={{ marginTop: "90px", }}>{true ? <h4 style={{ marginLeft: "20px" }}>APP</h4> : <h4 style={{ marginLeft: "20px" }}></h4>}</div>
            <div>
